...
LifeCell::LifeCell(int x, int y, int width, int height, float r, float g, float b, int value): GCA::Cell(x, y, value), sf::RectangleShape(sf::Vector2<float>{(float) width, (float) height}), width{width}, height{height}{
